...
<div>
    ...
    <div class="inline_player_playlist_main">
        ...
        // fixme когда запускаешь эту песню, сразу начинает играть следующая песня,
        //  а не должна или заказчик так попросил сделать ( у плеера включается пауза он в 0 секундах но не дезактивируется и выскакивает попап который скинула в тг)?
        $song_id = '4';
        $clicks = 3;
