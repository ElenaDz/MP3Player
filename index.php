...
<div>
    ...
    <div class="inline_player_playlist_main">
        ...
        // fixme запуск исправной песни должен приводить к тому, что алерт исчезает ok
        // fixme если дождаться исчезновения алерта и снова нажать на плей этой же сломанной песни, он не появиться снова ok
